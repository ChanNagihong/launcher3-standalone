...
import com.nagihong.launcher3_standalone.R;
import com.nagihong.launcher3_standalone.launcher.DropTarget.DragObject;
import com.nagihong.launcher3_standalone.launcher.LauncherSettings.Favorites;
import com.nagihong.launcher3_standalone.launcher.accessibility.LauncherAccessibilityDelegate;
import com.nagihong.launcher3_standalone.launcher.allapps.AllAppsContainerView;
import com.nagihong.launcher3_standalone.launcher.allapps.AllAppsTransitionController;
import com.nagihong.launcher3_standalone.launcher.allapps.DefaultAppSearchController;
import com.nagihong.launcher3_standalone.launcher.compat.AppWidgetManagerCompat;
import com.nagihong.launcher3_standalone.launcher.compat.LauncherActivityInfoCompat;
import com.nagihong.launcher3_standalone.launcher.compat.LauncherAppsCompat;
import com.nagihong.launcher3_standalone.launcher.compat.UserHandleCompat;
import com.nagihong.launcher3_standalone.launcher.compat.UserManagerCompat;
import com.nagihong.launcher3_standalone.config.FeatureFlags;
import com.nagihong.launcher3_standalone.config.ProviderConfig;
import com.nagihong.launcher3_standalone.launcher.dragndrop.DragController;
import com.nagihong.launcher3_standalone.launcher.dragndrop.DragLayer;
import com.nagihong.launcher3_standalone.launcher.dragndrop.DragOptions;
import com.nagihong.launcher3_standalone.launcher.dragndrop.DragView;
import com.nagihong.launcher3_standalone.launcher.dynamicui.ExtractedColors;
import com.nagihong.launcher3_standalone.launcher.folder.Folder;
import com.nagihong.launcher3_standalone.launcher.folder.FolderIcon;
import com.nagihong.launcher3_standalone.launcher.keyboard.ViewGroupFocusHelper;
import com.nagihong.launcher3_standalone.launcher.logging.FileLog;
import com.nagihong.launcher3_standalone.launcher.logging.UserEventDispatcher;
import com.nagihong.launcher3_standalone.launcher.model.WidgetsModel;
import com.nagihong.launcher3_standalone.launcher.pageindicators.PageIndicator;
import com.nagihong.launcher3_standalone.launcher.shortcuts.DeepShortcutManager;
import com.nagihong.launcher3_standalone.launcher.shortcuts.DeepShortcutsContainer;
import com.nagihong.launcher3_standalone.launcher.shortcuts.ShortcutKey;
import com.nagihong.launcher3_standalone.userevent.nano.LauncherLogProto;
import com.nagihong.launcher3_standalone.launcher.util.ActivityResultInfo;
import com.nagihong.launcher3_standalone.launcher.util.ComponentKey;
import com.nagihong.launcher3_standalone.launcher.util.ItemInfoMatcher;
import com.nagihong.launcher3_standalone.launcher.util.MultiHashMap;
import com.nagihong.launcher3_standalone.launcher.util.PackageManagerHelper;
import com.nagihong.launcher3_standalone.launcher.util.PendingRequestArgs;
import com.nagihong.launcher3_standalone.launcher.util.TestingUtils;
import com.nagihong.launcher3_standalone.launcher.util.Thunk;
import com.nagihong.launcher3_standalone.launcher.util.ViewOnDrawExecutor;
import com.nagihong.launcher3_standalone.launcher.widget.PendingAddWidgetInfo;
import com.nagihong.launcher3_standalone.launcher.widget.WidgetHostViewLoader;
import com.nagihong.launcher3_standalone.launcher.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.nagihong.launcher3_standalone.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";

    public static final String ACTION_APPWIDGET_HOST_RESET =
            "com.nagihong.launcher3_standalone.intent.ACTION_APPWIDGET_HOST_RESET";
