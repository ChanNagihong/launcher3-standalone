...
package com.nagihong.launcher3_standalone.launcher.folder;
...
import com.nagihong.launcher3_standalone.launcher.BubbleTextView;
import com.nagihong.launcher3_standalone.launcher.CellLayout;
import com.nagihong.launcher3_standalone.launcher.DeviceProfile;
import com.nagihong.launcher3_standalone.launcher.FocusHelper.PagedFolderKeyEventListener;
import com.nagihong.launcher3_standalone.launcher.IconCache;
import com.nagihong.launcher3_standalone.launcher.InvariantDeviceProfile;
import com.nagihong.launcher3_standalone.launcher.ItemInfo;
...
import com.nagihong.launcher3_standalone.launcher.LauncherModel;
import com.nagihong.launcher3_standalone.launcher.PagedView;
import com.nagihong.launcher3_standalone.R;
import com.nagihong.launcher3_standalone.launcher.ShortcutAndWidgetContainer;
...
import com.nagihong.launcher3_standalone.launcher.Workspace.ItemOperator;
...
import static com.nagihong.launcher3_standalone.R.styleable.PagedView;
import static com.nagihong.launcher3_standalone.android.gallery3d.exif.ExifInterface.ComponentsConfiguration.R;
...
public class FolderPagedView extends PagedView {
    ...
    public FolderPagedView(Context context, AttributeSet attrs) {
        ...
        setEdgeGlowColor(getResources().getColor(com.nagihong.launcher3_standalone.R.color.folder_edge_effect_color));
    ...
    public void setFolder(Folder folder) {
        ...
        mPageIndicator = (PageIndicator) folder.findViewById(com.nagihong.launcher3_standalone.R.id.folder_page_indicator);
    ...
    public View createNewView(ShortcutInfo item) {
        final BubbleTextView textView = (BubbleTextView) mInflater.inflate(
                com.nagihong.launcher3_standalone.R.layout.folder_application, null, false);
    ...
    public String getAccessibilityDescription() {
        return getContext().getString(com.nagihong.launcher3_standalone.R.string.folder_opened, mGridCountX, mGridCountY);
    }
