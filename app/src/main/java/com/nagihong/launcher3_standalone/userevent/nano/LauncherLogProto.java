...
package com.nagihong.launcher3_standalone.userevent.nano;
...
public interface LauncherLogProto {
  ...
  public static final class Target extends
    ...
    public Target clear() {
      ...
      gridX = 0;
      gridY = 0;
      containerType = DEFAULT_CONTAINERTYPE;
      cardinality = 0;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.containerType != DEFAULT_CONTAINERTYPE) {
        output.writeInt32(6, this.containerType);
      }
      if (this.cardinality != 0) {
        output.writeInt32(7, this.cardinality);
      }
      if (this.controlType != DEFAULT_CONTROLTYPE) {
        output.writeInt32(8, this.controlType);
      }
      if (this.itemType != DEFAULT_ITEMTYPE) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 64: {
            int value = input.readInt32();
            switch (value) {
              case DEFAULT_CONTROLTYPE:
              case ALL_APPS_BUTTON:
              case WIDGETS_BUTTON:
              case WALLPAPER_BUTTON:
              case SETTINGS_BUTTON:
              case REMOVE_TARGET:
              case UNINSTALL_TARGET:
              case APPINFO_TARGET:
              case RESIZE_HANDLE:
